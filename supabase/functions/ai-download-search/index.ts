...
type SearchResult = { url: string; title: string; confidence: number };

async function simulateSearch(query: string, strategies: string[]): Promise<SearchResult[]> {
  // This is a mock implementation. In production, you'd integrate with a search API.

  const mockNkiriResults: SearchResult[] = [
    {
