...
const OnboardingLanding: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-tr from-zinc-900 via-[#25032a] to-cinemax-900 overflow-hidden flex flex-col items-center justify-center">
      ...
      <section className="w-full max-w-3xl mx-auto px-6 sm:px-10 pt-24 pb-12 flex flex-col items-center relative z-10">
        ...
        <p className="text-base sm:text-lg text-cinemax-200/90 text-center max-w-2xl mx-auto mb-6 font-medium">
          Unlock an endless world of movies, shows, anime, and sports. Experience seamless streaming, curated collections, and your own personalized library — all in one elegant platform.
        </p>
        <button
      ...
      <section className="w-full max-w-5xl mx-auto px-6 pb-14 relative z-10">
        <div className="flex flex-wrap gap-6 justify-center">
          {features.map((feat, idx) => (
            <div
              key={idx}
              className="group backdrop-blur-2xl bg-white/5 dark:bg-[#3c3440]/20 border border-white/10 shadow-[0_6px_32px_rgba(75,0,75,0.09)] rounded-2xl flex flex-col items-center text-center p-6 w-full min-w-[220px] max-w-xs transition-all hover:scale-105 hover:bg-white/10 hover:shadow-xl"
            >
              <div className="mb-3">
                {feat.icon}
              </div>
