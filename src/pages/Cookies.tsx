...
const Cookies = () => {
  ...
  const saveCookiePreferences = () => {
    ...
    // Here you would typically send this to your analytics/tracking services
            ...
            <Card className="p-6 bg-secondary/20 border-gray-800">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="bg-gray-800/50 p-3 rounded">
                  ...
                  <p className="text-gray-300">Website traffic analysis</p>
                </div>
                <div className="bg-gray-800/50 p-3 rounded">
                  <strong className="text-cinemax-400">Cloudflare</strong>
                  <p className="text-gray-300">Security and performance</p>
                </div>
                <div className="bg-gray-800/50 p-3 rounded">
                  <strong className="text-cinemax-400">YouTube</strong>
                  <p className="text-gray-300">Video trailer embedding</p>
                </div>
                <div className="bg-gray-800/50 p-3 rounded">
                  <strong className="text-cinemax-400">Social Media</strong>
                  <p className="text-gray-300">Social media integration</p>
                </div>
              </div>
            </Card>
