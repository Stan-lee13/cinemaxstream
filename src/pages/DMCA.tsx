    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 pt-24 pb-12 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            className="dmca-header mb-16 px-2"
          ...
          <div className="space-y-8">
            ...
            >
              <Card className="bg-[#111]/80 border border-white/5 backdrop-blur-xl rounded-[40px] p-8 md:p-12 overflow-hidden relative group">
            ...
            >
              <Card className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-white/5 rounded-[40px] p-8 md:p-12 relative overflow-hidden group">
