...
const contactSchema = z.object({
  ...
  subject: z.string().trim().min(3, 'Subject must be at least 3 characters').max(200, 'Subject must be less than 200 characters').optional(),
...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent(validated.subject || 'CinemaxStream Support Request');
