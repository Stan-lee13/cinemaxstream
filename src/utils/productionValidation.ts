...
export class ProductionValidator {
  ...
  static async isValidPromoCode(code: string): Promise<boolean> {
    ...
    try {
      ...
      if (typeof data.current_uses === 'number' && typeof data.max_uses === 'number') {
        if (data.current_uses >= data.max_uses) return false;
      }
