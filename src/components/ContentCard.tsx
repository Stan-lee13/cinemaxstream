        ...
        <div className="movie-card h-[260px] sm:h-[300px] relative">
          ...
          <div className="movie-overlay">
            ...
            <div className="flex gap-2 mt-2">
              <Button 
                className="h-9 rounded-md px-3 w-full gap-1 bg-secondary text-secondary-foreground hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
